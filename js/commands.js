var youtube = "https://www.youtube.com/channel/UCwynM7ejfAQaT4DdbBv2rSA";
var twitter = "https://www.twitter.com/SreemanTech/";
var password = "Kali-Box";
var instagram = "https://www.instagram.com/me_sriman/";
var github = "https://github.com/sreeman-tech/";
var email = 'mailto:sreemantech0@gmail.com';
...
social = [
  "<br>",
  'youtube        <a href="' + youtube + '" target="_blank">youtube/Sreeman-Tech' + "</a>",
  'twitter        <a href="' + twitter + '" target="_blank">twitter/SreemanTech' + '</a>',
  'instagram      <a href="' + instagram + '" target="_blank">instagram/me_sriman' + '</a>',
  'github         <a href="' + github + '" target="_blank">github/sreeman-tech' + "</a>",
  "<br>"
];
...
help = [
  "<br>",
  '<span class="command">whois</span>          Who is sreeman?',
...
banner = [
  '<span class="index"> SREEMAN-TECH (ICD.ATOMS) Not A Corporation. All rights reserved.</span>',
  "         ___   ____",
  "       /' --;^/ ,-_\\     \\ | /       ",
  "      / / --o\\ o-\\ \\\\   --(_)--   ",
